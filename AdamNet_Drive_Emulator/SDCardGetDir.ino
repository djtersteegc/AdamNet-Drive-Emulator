void SDCardGetDir(int DisplayError){                               // Setup the SD Card
  ...
  if (DirLevel == 1){                      // In the first level of dir. Only add the [..]
    NumberofFiles++;
    TypeIndex[NumberofFiles] = 2;          // TypeIndex 2 is the indication that this is the [..] entry
  }
...
// Sort the 2 arrays by the type from low to high. Puts the [..] and [/] first if they exist for this dir.
